...
let s:grey0     = {"hex": '#414141', "term": 253}
...
let s:turquoise = {"hex": '#79dac8', "term": 50}
...
exec 'highlight IncSearch ctermbg=bg ctermfg=' . s:coral.term . ' cterm=reverse guibg=bg guifg=' . s:coral.hex . ' gui=reverse'
exec 'highlight CurSearch ctermbg=bg ctermfg=' . s:coral.term . ' cterm=reverse guibg=bg guifg=' . s:coral.hex . ' gui=reverse'
" exec 'highlight CurSearch ctermbg=bg ctermfg=' . s:coral.term . ' cterm=reverse guibg=bg guifg=' . s:crimson.hex . ' gui=reverse'
